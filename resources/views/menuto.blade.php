...
@section('meta')
    ...
    <title>{{ trans('site.menuto_title') }}</title>

    <meta name="description" content="{{ trans('site.menuto_description') }}">



    <meta property="og:title" content="{{ trans('site.menuto_title') }}" />

    <meta property="og:description" content="{{ trans('site.menuto_description') }}" />
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <h1 class="text-center" style="color: #855a38; margin: 10px 0 26px 0;">{{ trans('site.menuto_menu') }}</h1>
                    <h2 class="text-center" style="color: #855a38; margin: 0 0 25px 0;">{{ trans('site.menuto_hrana') }}</h2>

                    <p class="text-center font-16" style="margin-bottom: 25px; color: #51382f;">{!! trans('site.menuto_intro') !!}</p>
